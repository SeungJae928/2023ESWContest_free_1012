  ...
  return (
    <View style={[styles.view]}>
      <View>
        ...
        <View>
          <TextInput style={styles.textInput_1} placeholder="Username"/>
        </View>

        <Text style={styles.button} onPress = {()=>navigation.navigate('SignUp_Email')}> NEXT  
            <Icon name = 'arrow-right' size = {20}/> 
        </Text>
        
        <Text style={styles.instruction}> Instructions : Set Your Username(id).
        </Text>
...
// 유저 이름의 길이가 0일 때, 또는 username이 이미 존재할 때
